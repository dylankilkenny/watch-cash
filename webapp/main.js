...
const applicationServerPublicKey =
  'BBnC9tDS3VemSDiBY7rnMC_HMkme6saCWW2QYWrtoHtrZrmcexqadyIzWITAM3kxhUSJ7dd6p2avkKAGbxwpm2s';
...
var ua = window.navigator.userAgent,
  ...
  version = ua
    .substring(0, safariTxt)
    .substring(ua.substring(0, safariTxt).lastIndexOf('/') + 1);
var actionButton = document.querySelector('.action-button');
let isSubscribed = false;
let swRegistration = null;

console.log(
  '%c WebPush script injected.',
  'background: green; color: white; display: block; font-size:20px'
);
...
function requestPermissions() {
  window.safari.pushNotification.requestPermission(
    'https://apps.wearetrying.info/push-api',
    domain,
    {},
